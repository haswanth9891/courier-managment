...
public class ExceptionHandlingInvalidEmployeeId {
    ...
    // Default constructor
    public ExceptionHandlingInvalidEmployeeId() {}

    // Parameterized constructor
    public ExceptionHandlingInvalidEmployeeId(long employeeID, String employeeName, String email, long contactNumber, String role, double salary) {
    ...
    public static void validateEmployeeId(long employeeID) {
        ...
        if(!found)
        {
            System.out.println("EmployeeIdNotFound");
        }
    }
